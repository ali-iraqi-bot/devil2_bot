...
~~ Source devil2_bot For Supergroups 
...
git clone https://github.com/ali-iraqi-bot/devil2_bot.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf devil2_bot && rm -rf .telegram-cli && git clone https://github.com/ali-iraqi-bot/devil2_bot.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
